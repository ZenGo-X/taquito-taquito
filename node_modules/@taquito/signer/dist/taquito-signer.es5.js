...
import { b58cdecode, prefix, buf2hex, b58cencode, hex2buf, mergebuf } from '@taquito/utils';
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [2 /*return*/, b58cencode(sodium.crypto_generichash(20, new Uint8Array(this._publicKey)), prefix.tz1)];
                }
            });
        });
    };
...
//# sourceMappingURL=taquito-signer.es5.js.map
