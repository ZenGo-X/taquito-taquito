import { OperationBalanceUpdates, OperationObject, ScriptedContracts, OperationContentsAndResultMetadataOrigination } from './types.common';
...
export declare type RPCRunOperationParam005 = {
    operation: OperationObject;
    chain_id: string;
};
export declare type EntrypointsResponse005 = {
    entrypoints: {
        [key: string]: Object;
    };
    unreachable?: {
