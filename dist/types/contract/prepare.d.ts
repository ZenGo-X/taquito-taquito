...
export declare const createSetDelegateOperation: ({ delegate, source, publicKey, fee, gasLimit, storageLimit, }: DelegateParams) => Promise<RPCDelegateOperation>;
export declare const createRegisterDelegateOperation: ({ fee, gasLimit, storageLimit, }: RegisterDelegateParams, source: string, publicKey?: string | undefined) => Promise<RPCDelegateOperation>;
